...
1. Выберите любую сыллку из таблицы сверху и скопируйте её (Советуем sub1.txt, sub3.txt и sub8.txt) ВАЖНО: Если у вас слабое устройство не берите подписки где овень много коныигураций.
